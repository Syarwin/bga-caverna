...
$machinestates = [
  ...
  ST_BREED => [
    ...
    'descriptionruby' => clienttranslate('${actplayer} may use ruby(ies) before breeding all their animals'),
    'descriptionmyturnruby' => clienttranslate('${you} may use ruby(ies) before breeding all your animals'),

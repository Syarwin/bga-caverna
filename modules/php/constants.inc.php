...
const FARM_ANIMALS = [SHEEP, PIG, CATTLE, DONKEY];
...
const STAT_DONKEY_FROM_BOARD = 84;

const STAT_WOOD_FROM_BUILDINGS = 45;
const STAT_STONE_FROM_BUILDINGS = 46;
const STAT_ORE_FROM_BUILDINGS = 47;
const STAT_RUBY_FROM_BUILDINGS = 48;
const STAT_GRAIN_FROM_BUILDINGS = 49;
const STAT_VEGETABLE_FROM_BUILDINGS = 50;
const STAT_FOOD_FROM_BUILDINGS = 51;
const STAT_SHEEP_FROM_BUILDINGS = 52;
const STAT_PIG_FROM_BUILDINGS = 53;
const STAT_CATTLE_FROM_BUILDINGS = 54;
const STAT_DONKEY_FROM_BUILDINGS = 82;

const STAT_BUILDINGS_BUILT = 58;
...
const STAT_DONKEY_CONVERTED = 83;
...
const STAT_FOOD_FROM_DONKEY = 85;
...
const STAT_BEGGING_FROM_BUILDINGS = 77;
